...
class Kaisin < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/bluepawlabs/kaisin/releases/download/v#{version}/kaisin-#{version}-osx-arm64.tar.gz"
      sha256 "cbc6d3d01593b964291db48d3152e052755a9bcbdb8c1f294ea0c6cddd7e7a6d"
    else
      url "https://github.com/bluepawlabs/kaisin/releases/download/v#{version}/kaisin-#{version}-osx-x64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/bluepawlabs/kaisin/releases/download/v#{version}/kaisin-#{version}-linux-arm64.tar.gz"
      sha256 "fb35873acd3c28fd2c778fc07b994b28cb94a45e83e5ee2d4d3534453b3243a8"
    else
      url "https://github.com/bluepawlabs/kaisin/releases/download/v#{version}/kaisin-#{version}-linux-x64.tar.gz"
